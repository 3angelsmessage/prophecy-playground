        ...
        <div className="flex items-center justify-between">
          <motion.div whileHover={{ scale: 1.05 }} className="flex items-center gap-2">
            ...
            <div className="hidden sm:block">
              <h1 className="font-display text-2xl font-extrabold leading-none" style={{ color: 'hsl(120, 100%, 40%)', textShadow: '-1px -1px 0 goldenrod, 1px -1px 0 goldenrod, -1px 1px 0 goldenrod, 1px 1px 0 goldenrod' }}>
                Prophecy Kids
              </h1>
            </div>
          </motion.div>

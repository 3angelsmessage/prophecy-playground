...
const timelineEventsData = {
  en: [
    ...
    { id: "ten-toes", event: "Ten Toes - Divided Europe", year: "476 AD", emoji: "🦶", order: 4, description: "Iron & clay represent division in Europe" },
    { id: "gods-kingdom", event: "God Sets Up His Kingdom", year: "Future", emoji: "👑", order: 5, description: "God's eternal kingdom replaces all earthly kingdoms" },
  ],
  fr: [
    ...
    { id: "ten-toes", event: "Dix Orteils - Europe Divisée", year: "476 ap. J.-C.", emoji: "🦶", order: 4, description: "Le fer et l'argile représentent la division en Europe" },
    { id: "gods-kingdom", event: "Dieu Établit Son Royaume", year: "Futur", emoji: "👑", order: 5, description: "Le royaume éternel de Dieu remplace tous les royaumes terrestres" },
  ],
  es: [
    ...
    { id: "ten-toes", event: "Diez Dedos - Europa Dividida", year: "476 d.C.", emoji: "🦶", order: 4, description: "El hierro y el barro representan la división en Europa" },
    { id: "gods-kingdom", event: "Dios Establece Su Reino", year: "Futuro", emoji: "👑", order: 5, description: "El reino eterno de Dios reemplaza todos los reinos terrenales" },
  ],
};
